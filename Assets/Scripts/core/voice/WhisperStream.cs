...
namespace Voice {
    ...
    public class WhisperStream {
        ...
        public WhisperStream(
            WhisperWrapper wrapper, WhisperStreamParams param,
        ...
        public void StartStream() {
            if (_isStreaming) {
                LogUtils.Verbose("Stream is already working!");
                return;
            }
        ...
        public async void AddToStream(AudioChunk chunk) {
            if (!_isStreaming) {
                LogUtils.Verbose("Start streaming first!");
                return;
            }
