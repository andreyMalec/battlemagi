    ...
    public class MicrophoneRecord : MonoBehaviour
    {
        ...
        public string SelectedMicDevice
        {
            ...
            set {
                ...
                _selectedMicDevice = !AvailableMicDevices.Contains(value) ? null : value;
            }
        }
        ...
        private void Awake()
        {
            ...
            SelectedMicDevice = PlayerPrefs.GetString("Microphone", null);
        }
        ...
        public float GetAmplitude()
        {
            ...
            int micPos = Microphone.GetPosition(RecordStartMicDevice);
            if (micPos < sampleWindow) return 0f;

            float[] data = new float[sampleWindow];
            _clip.GetData(data, micPos - sampleWindow);
        ...
        public void StartRecord()
        {
            ...
            if (AvailableMicDevices.Count() == 0)
                return;
