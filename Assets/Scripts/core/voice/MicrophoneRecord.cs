...
namespace Voice {
    ...
    public class MicrophoneRecord : MonoBehaviour {
        ...
        [Tooltip("Microphone sample rate")] public int frequency = 16000;
        ...
        public Transform echoPosition;

        [Header("Voice Activity Detection (VAD)")] [Tooltip("Should microphone check if audio input has speech?")]
        ...
        [Header("VAD Stop")] [Tooltip("If true microphone will stop record when no speech detected")]
        public bool vadStop;
        ...
        public void StopRecord(float dropTimeSec = 0f) {
            ...
            if (echo) {
                ...
                PlayAudioAndDestroy.Play(echoClip, echoPosition.position);
            }
