...
namespace RealtimeCSG
{
	internal static class Keys
	{
		...
		public static readonly KeyEvent SwitchToObjectEditMode			= new KeyEvent(KeyCode.Alpha1, EventModifiers.Control);
		...
		public static readonly KeyEvent SwitchToMeshEditMode			= new KeyEvent(KeyCode.Alpha3, EventModifiers.Control);
